...
$websiteOptions[] = array('separator', 'separator4', 'Service card texts');
$websiteOptions[] = array('text', 'service_om_text', 'Online marketing tekst');
$websiteOptions[] = array('text', 'service_wd_text', 'Webdevelopment tekst');
$websiteOptions[] = array('text', 'service_e_text', 'Events tekst');
...
$websiteOptions[] = array('separator', 'separator7', 'Statistieken');
